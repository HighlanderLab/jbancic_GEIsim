...
# Script name: Simulate phenotypic line breeding program with moderate GEI
#
...
#-- Set scenario name
Scenario = paste0("PhenoGEI_",weightMean,"-",weightSD)
...
for(year in 1:nCycles){ 
  ...
  if (year <= nYearsTP) {
    # Phenotypic selection first 3 years where MET is just current year's data 
